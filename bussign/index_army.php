...
$stopId2 = "";
if (isset($_REQUEST['sid2']) && isset($_REQUEST['agency2'])) {
	if ($_REQUEST['sid2'] != "") {
...
// Careful, the headsign below is used by MARTA for BOTH #12 northbound and southbound trips. Change to the correct one when making signs.
...
function printPageHeader($stopName) {
	...
	<div class='header'>
		...
		<div class='float-right'>
			<h2 style='text-align:left;'>08-AUG-2015<br/><!--Expiration date goes here if needed.--></h2>
		</div>
		<div class='float-right' style='border-left: 1px solid #D0D0D0; padding-left: 15px;'>
			...
			<br />&nbsp;<!--Expiration label goes here if needed.--><!--Exp.:--></h2>
			<!--br />Exp. &#x25BA;</h2-->
		</div>
		<div class='float-right'>
